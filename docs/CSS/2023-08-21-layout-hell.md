...
而我選用的教材是 Huli 大大開設的 Lidemy 網站課程，以及參考他自辦 bootcamp 的課綱來學習和做作業。

## 學習沿革

當時我是照本宣科地自學，沒有老師批改，所以每次切版只是草草帶過，  
...
所以幾乎是以純手刻的方式做開發（而且還沒有充分運用 SCSS 導致本來可以全局管理的東西都變得很混亂）。

沒有前期規劃的概念，導致我在第二週與第三週的挑戰都沒有時限內完成，  
因為經常需要邊改樣式邊整合 React 邏輯，既沒有效率，  
